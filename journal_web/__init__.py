...
@app.route("/precache-manifest.ce631a0913a7a522fad9a16a342e75bb.js")
def precache():
    return app.send_static_file("build/precache-manifest.ce631a0913a7a522fad9a16a342e75bb.js")
